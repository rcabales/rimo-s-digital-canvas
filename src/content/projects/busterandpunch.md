...
I owned the non-e-commerce sections of the site, primarily the editorial and blog areas, handling both front-end and back-end development. The split architecture, WooCommerce handling commerce and custom WordPress handling editorial, required clear boundaries to avoid the two bleeding into each other in ways that would create maintenance headaches.
